...
class ExpertisesControllerTest < ActionController::TestCase
  ...
  test "should create expertise" do
    assert_difference('Expertise.count') do
      post :create, expertise: { area: @expertise.area, negative: @expertise.negative, positive: @expertise.positive }
    end
  ...
  test "should update expertise" do
    put :update, id: @expertise, expertise: { area: @expertise.area, negative: @expertise.negative, positive: @expertise.positive }
    assert_redirected_to expertise_path(assigns(:expertise))
  end
